...
public class MenuRecomendaciones {
	...
	// Methods
	public Object[] RecomendacionPeliculasAltas(Object nuevo[], RatingType valoracion, String comentarios) {
	...
	public Object[] RecomendacionBajasPorValoracion(Object nuevo[], RatingType valoracion) {
...
//It returns the modified array.
	public Object[] RecomendacionesModificacionPorValoracion(Object nuevo[], RatingType valoracion, RatingType nuevaValoracion) {
		nuevo = (Recomendacion[]) rec;
...
//This loop iterates through the recommendations array and searches for recommendations that contain the comment to search for. If it is not found, the user will be notified.
	...
	public void RecomendacionesBusquedaPorValoracion(Object nuevo[], RatingType valoracion) {
		nuevo = (Recomendacion[]) rec;
